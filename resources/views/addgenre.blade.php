            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                ...
                <form method="POST" action="/addgenre">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="genrename" class="bg-gray-800 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white"  placeholder='Enter genre name'></textarea>
